...
Structured markers don't drift because they're not summaries — they're *data*. `DECISIONS: ...`. `OPEN_QUESTIONS: ...`. `PROGRESS: step 4 of ~12`. The engine reads them as data. The model fills the schema instead of summarizing the conversation.
