...
The rule of thumb from [`docs/chunk-config.md`](../../docs/chunk-config.md): carryover should be **10–15% of `tokensPerChunk`** — lower for information-light work, higher for state-heavy work.
...
const profiles = {
  "information-light": { tokensPerChunk: 6000, carryoverTokens: 400 },  // ~7%
  "decision-heavy":    { tokensPerChunk: 6000, carryoverTokens: 900 },  // ~15%
  "state-heavy":       { tokensPerChunk: 6000, carryoverTokens: 1300 }, // ~22%
};
